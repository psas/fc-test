...
RNH = {
    ...
    'commands': {
        ...
        'On1':  {'name': "1 On",     'message': "#PORT"+chr(2)+chr(1<<0), 'from-port': 34000, 'btn': "warning"},
        'On2':  {'name': "2 On",     'message': "#PORT"+chr(2)+chr(1<<1), 'from-port': 34000, 'btn': "warning"},
        'On3':  {'name': "3 On",     'message': "#PORT"+chr(2)+chr(1<<2), 'from-port': 34000, 'btn': "warning"},
        'On4':  {'name': "4 On",     'message': "#PORT"+chr(2)+chr(1<<3), 'from-port': 34000, 'btn': "warning"},
        'On6':  {'name': "6 On",     'message': "#PORT"+chr(2)+chr(1<<5), 'from-port': 34000, 'btn': "warning"},
        'On7':  {'name': "7 On",     'message': "#PORT"+chr(2)+chr(1<<6), 'from-port': 34000, 'btn': "warning"},
        'On8':  {'name': "8 On",     'message': "#PORT"+chr(2)+chr(1<<7), 'from-port': 34000, 'btn': "warning"},
        'off1': {'name': "1 Off",    'message': "#PORT"+chr(3)+chr(1<<0), 'from-port': 34000, 'btn': "default"},
        'off2': {'name': "2 Off",    'message': "#PORT"+chr(3)+chr(1<<1), 'from-port': 34000, 'btn': "default"},
        'off3': {'name': "3 Off",    'message': "#PORT"+chr(3)+chr(1<<2), 'from-port': 34000, 'btn': "default"},
        'off4': {'name': "4 Off",    'message': "#PORT"+chr(3)+chr(1<<3), 'from-port': 34000, 'btn': "default"},
        'off6': {'name': "6 Off",    'message': "#PORT"+chr(3)+chr(1<<5), 'from-port': 34000, 'btn': "default"},
        'off7': {'name': "7 Off",    'message': "#PORT"+chr(3)+chr(1<<6), 'from-port': 34000, 'btn': "default"},
        'off8': {'name': "8 Off",    'message': "#PORT"+chr(3)+chr(1<<7), 'from-port': 34000, 'btn': "default"},
    }
}
